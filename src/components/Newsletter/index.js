...
//           <label htmlFor="name">
//             <Styled.Input id="name" type="text" name="Name" placeholder={newsletter.namePlaceholder} required />
//           </label>
//           <label htmlFor="email">
//             <Styled.Input type="email" name="Email" id="email" placeholder={newsletter.emailPlaceholder} required />
//           </label>
